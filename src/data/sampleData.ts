...
export const bootstrapStatements = [
  ...
  `insert into raw_order_items values
    ...
    (1001, 2, 2, 302, 2, 11.75, 1175),
    (1002, 1, 1, 302, 2, 11.75, 1175),
    (1003, 1, 1, 303, 2, 64.50, 6450),
    (1003, 2, 2, 305, 1, 17.60, 1760),
  ...
  `insert into raw_payments values
    ...
    (506, 1001, 'card', 'failed', '59.99', '2024-01-01 08:15:40', '2024-01-01 08:16:00'),
    ...
    (507, 1003, 'card', 'captured', '146.60', '2024-01-01 08:25:00', '2024-01-06 09:00:00'),
  ...
  `insert into raw_returns values
    (701, 1001, 2, 'completed', 23.50, '2024-01-03 10:00:00', '2024-01-04 15:30:00'),
    (702, 1003, 1, 'requested', 64.50, '2024-01-08 09:15:00', null),
    (703, 1004, 1, 'rejected', 15.00, '2024-01-07 11:20:00', '2024-01-07 16:45:00')`,
]
